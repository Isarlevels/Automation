...
public class Voice_Service_Scenario_10 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
			...
			act.moveToElement(driver.findElement(By.id("S05.L06.QN04.QC1Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S05.L06.QN04.QC1Response1")).click();
			act.moveToElement(driver.findElement(By.xpath("//input[@id='S05.L06.QN04.QC4Response2']"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.xpath("//input[@id='S05.L06.QN04.QC4Response2']")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			...
			act.moveToElement(driver.findElement(By.id("S08.L03.QN06.QC1Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S08.L03.QN06.QC1Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			act.moveToElement(driver.findElement(By.id("S11.L03.QN07.QC1Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S11.L03.QN07.QC1Response1")).click();
			...
			driver.findElement(By.id("S12.L02.QN08.QC1Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			driver.findElement(By.id("S14.L01.QN09.QC1Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			act.moveToElement(driver.findElement(By.id("S15.L02.QN10.QC3Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S15.L02.QN10.QC3Response1")).click();
			act.moveToElement(driver.findElement(By.id("S15.L02.QN10.QC5Response2"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S15.L02.QN10.QC5Response2")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
	}
