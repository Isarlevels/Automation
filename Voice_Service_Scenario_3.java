...
public class Voice_Service_Scenario_3 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
			...
			act.moveToElement(driver.findElement(By.id("S01.L01.QN01.QC5Response1"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.id("S01.L01.QN01.QC5Response1")).click(); 
		    act.moveToElement(driver.findElement(By.id("S01.L01.QN01.QC4Response2"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.id("S01.L01.QN01.QC4Response2")).click(); 
			...
			driver.findElement(By.id("S03.L01.QN02.QC2Response1")).click();
			w.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector(".send-btn"))));
			driver.findElement(By.cssSelector(".send-btn")).click();
			act.pause(30000);
			
			act.moveToElement(driver.findElement(By.id("S05.L06.QN04.QC5Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S05.L06.QN04.QC5Response1")).click();
			act.moveToElement(driver.findElement(By.xpath("//input[@id='S05.L06.QN04.QC2Response2']"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.xpath("//input[@id='S05.L06.QN04.QC2Response2']")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			act.moveToElement(driver.findElement(By.id("S06.L03.QN05.QC5Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S06.L03.QN05.QC5Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			act.moveToElement(driver.findElement(By.id("S08.L01.QN06.QC2Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S08.L01.QN06.QC2Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			act.moveToElement(driver.findElement(By.id("S11.L03.QN07.QC5Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S11.L03.QN07.QC5Response1")).click();
			act.moveToElement(driver.findElement(By.id("S11.L03.QN07.QC3Response2"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S11.L03.QN07.QC3Response2")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			driver.findElement(By.id("S12.L02.QN08.QC2Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			
			act.moveToElement(driver.findElement(By.id("S15.L02.QN10.QC1Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S15.L02.QN10.QC1Response1")).click();
			act.moveToElement(driver.findElement(By.id("S15.L02.QN10.QC4Response2"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S15.L02.QN10.QC4Response2")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
	}
