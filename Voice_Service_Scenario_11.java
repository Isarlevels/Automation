...
public class Voice_Service_Scenario_11 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
			...
			act.moveToElement(driver.findElement(By.id("S06.L03.QN05.QC2Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S06.L03.QN05.QC2Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			...
			act.moveToElement(driver.findElement(By.id("S15.L02.QN10.QC3Response2"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S15.L02.QN10.QC3Response2")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
	}
