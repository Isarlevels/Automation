...
public class Voice_Service_Scenario_8 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
			...
			act.moveToElement(driver.findElement(By.id("S01.L01.QN01.QC2Response1"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.id("S01.L01.QN01.QC2Response1")).click(); 
		    act.moveToElement(driver.findElement(By.id("S01.L01.QN01.QC3Response2"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.id("S01.L01.QN01.QC3Response2")).click(); 
			...
			driver.findElement(By.id("S04.L02.QN03.QC1Response1")).click();
			w.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.cssSelector(".send-btn"))));
			driver.findElement(By.cssSelector(".send-btn")).click();
			act.pause(30000);
			...
			act.pause(2000);
			driver.findElement(By.id("S06.L03.QN05.QC3Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
			...
			driver.findElement(By.id("S14.L03.QN09.QC2Response1")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
