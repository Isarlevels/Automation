...
public class Voice_Sales_Scenario_5 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
		    ...
		    act.moveToElement(driver.findElement((By.xpath("//input[@id='S02.L01.QN01.QC3Response1']")))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S02.L01.QN01.QC3Response1']")).click();
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S02.L01.QN01.QC4Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S02.L01.QN01.QC4Response2']")).click();
		    w.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".send-btn")));
		    driver.findElement(By.cssSelector(".send-btn")).click();
		  
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S03.L01.QN02.QC3Response1']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S03.L01.QN02.QC3Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		  
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC3Response1']"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC3Response1']")).click();
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC4Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC4Response2']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC3Response1']"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC3Response1']")).click();
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC4Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC4Response2']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S09.L10.QN11.QC3Response1']"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S09.L10.QN11.QC3Response1']")).click();
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S09.L10.QN11.QC4Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S09.L10.QN11.QC4Response2']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
