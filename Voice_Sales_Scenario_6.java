...
public class Voice_Sales_Scenario_6 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC4Response1']"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC4Response1']")).click();
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC5Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S04.L06.QN05.QC5Response2']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC1Response1']"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC1Response1']")).click();
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC2Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC2Response2']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S09.L10.QN11.QC1Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S09.L10.QN11.QC1Response2']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
