...
public class Voice_Service_Scenario_9 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
		    ...
		    act.moveToElement(driver.findElement(By.id("S01.L01.QN01.QC1Response2"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.id("S01.L01.QN01.QC1Response2")).click(); 
