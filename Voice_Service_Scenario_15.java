...
public class Voice_Service_Scenario_15 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
			...
			act.moveToElement(driver.findElement(By.id("S05.L06.QN04.QC2Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S05.L06.QN04.QC2Response1")).click();
			...
			act.moveToElement(driver.findElement(By.id("S11.L03.QN07.QC2Response1"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S11.L03.QN07.QC2Response1")).click();
			act.moveToElement(driver.findElement(By.id("S11.L03.QN07.QC4Response2"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.id("S11.L03.QN07.QC4Response2")).click();
			driver.findElement(By.cssSelector(".send-btn")).click();
