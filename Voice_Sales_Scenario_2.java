...
public class Voice_Sales_Scenario_2 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S02.L01.QN01.QC3Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S02.L01.QN01.QC3Response2']")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S03.L03.QN03.QC2Response1']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S03.L03.QN03.QC2Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		  
			driver.findElement(By.xpath("//input[@id='S03.L05.QN04.QC2Response1']")).click();
			w.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".send-btn")));
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S05.L01.QN06.QC2Response1']"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.xpath("//input[@id='S05.L01.QN06.QC2Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		  
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC2Response1']"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC2Response1']")).click();
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC3Response2']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S07.L01.QN08.QC3Response2']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S08.L02.QN09.QC2Response1']"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.xpath("//input[@id='S08.L02.QN09.QC2Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		  
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S08.L03.QN10.QC2Response1']"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.xpath("//input[@id='S08.L03.QN10.QC2Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
