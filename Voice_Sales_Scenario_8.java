...
public class Voice_Sales_Scenario_8 {
	...
	public static void main(String[] args) {
		...
		System.setProperty("webdriver.chrome.driver", "C:/Automation/chromedriver.exe");
	      ...
	      driver.manage().window().maximize();
		    ...
		    act.moveToElement(driver.findElement((By.xpath("//input[@id='S02.L01.QN01.QC4Response1']")))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S02.L01.QN01.QC4Response1']")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S03.L01.QN02.QC4Response1']"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.xpath("//input[@id='S03.L01.QN02.QC4Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S05.L01.QN06.QC4Response1']"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.xpath("//input[@id='S05.L01.QN06.QC4Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
		    ...
		    act.moveToElement(driver.findElement(By.xpath("//input[@id='S08.L02.QN09.QC4Response1']"))).click().build().perform();
			act.pause(2000);
			driver.findElement(By.xpath("//input[@id='S08.L02.QN09.QC4Response1']")).click();
		    driver.findElement(By.cssSelector(".send-btn")).click();
