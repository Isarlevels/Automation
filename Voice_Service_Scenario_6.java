...
public class Voice_Service_Scenario_6 {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
	      ...
	      driver.manage().window().maximize();
			...
			act.moveToElement(driver.findElement(By.id("S01.L01.QN01.QC1Response1"))).click().build().perform();
			act.pause(2000);
		    driver.findElement(By.id("S01.L01.QN01.QC1Response1")).click(); 
		    act.moveToElement(driver.findElement(By.id("S01.L01.QN01.QC5Response2"))).click().build().perform();
		    act.pause(2000);
		    driver.findElement(By.id("S01.L01.QN01.QC5Response2")).click(); 
